    ...
    if (Math.abs(x - ox) > 1 || Math.abs(y - oy) > 1) {
        ...
        for (c = 0; c < sparkles; c++) {
            if (!starv[c]) {
                ...
                star[c].childNodes[0].style.backgroundColor = star[c].childNodes[1].style.backgroundColor = (colour === "random") ? generateRainbowText() : colour;
